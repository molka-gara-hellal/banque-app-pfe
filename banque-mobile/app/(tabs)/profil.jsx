...
const MENU = [
  { title: "Mon compte", items: [
    { icon: "👤", label: "Informations personnelles", route: "/(tabs)/profile-pages/informations" },
    { icon: "🔒", label: "Sécurité & Mot de passe",  route: "/(tabs)/profile-pages/securite" },
    { icon: "📱", label: "Appareils connectés",       route: "/(tabs)/profile-pages/appareils" },
  ]},
  { title: "Préférences", items: [
    { icon: "🔔", label: "Notifications", route: "/(tabs)/profile-pages/notifications" },
    { icon: "🌍", label: "Langue",        route: "/(tabs)/profile-pages/langue" },
    { icon: "🎨", label: "Apparence",     route: "/(tabs)/profile-pages/apparence" },
  ]},
  { title: "Support", items: [
    { icon: "❓", label: "Aide & FAQ",                route: "/(tabs)/profile-pages/faq" },
    { icon: "📞", label: "Contacter le support",      route: "/(tabs)/profile-pages/support" },
    { icon: "📄", label: "Conditions d'utilisation",  route: "/(tabs)/profile-pages/conditions" },
  ]},
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={s.profileSection}>
          ...
          <View style={s.premiumBadge}>
            <Text style={s.premiumText}>✨ Client Premium</Text>
          </View>
        </View>
